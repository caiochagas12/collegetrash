...
namespace registrosaude
{
	public partial class Form11 : Form
	{
		...
		{
			textBox6 = dataGridView1.CurrentRow.Cells[0].Value.ToString();
			textBox5 = dataGridView1.CurrentRow.Cells[2].Value.ToString();

			textBox2 = dataGridView1.CurrentRow.Cells[3].Value.ToString();
			textBox1 = dataGridView1.CurrentRow.Cells[4].Value.ToString();
			textBox4 = dataGridView1.CurrentRow.Cells[5].Value.ToString();

			textBox3 = dataGridView1.CurrentRow.Cells[6].Value.ToString();
