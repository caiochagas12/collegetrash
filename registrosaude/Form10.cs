...
namespace registrosaude
{
	public partial class Form10 : Form
	{
		...
		{
			textBox10 = dataGridView1.CurrentRow.Cells[0].Value.ToString();
			textBox1 = dataGridView1.CurrentRow.Cells[2].Value.ToString();

			textBox11 = dataGridView1.CurrentRow.Cells[3].Value.ToString();
			textBox2 = dataGridView1.CurrentRow.Cells[4].Value.ToString();
			textBox3 = dataGridView1.CurrentRow.Cells[5].Value.ToString();
			...
			textBox6 = dataGridView1.CurrentRow.Cells[8].Value.ToString();
			textBox7 = dataGridView1.CurrentRow.Cells[9].Value.ToString();
			textBox8 = dataGridView1.CurrentRow.Cells[7].Value.ToString();
			textBox9 = dataGridView1.CurrentRow.Cells[8].Value.ToString();
		...
		{
			ClasseBLLLL bll = new ClasseBLLLL();
