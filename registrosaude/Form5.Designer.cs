namespace registrosaude
{
	partial class Form5
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Registrar Dono:";
			// 
			// label2
			// 
			...
			this.label2.Text = "Registrar animal:";
			// 
			// label3
			// 
			...
			this.label3.Text = "Registrar Funcionario:";
			// 
			// label4
			// 
			...
			this.label4.Text = "Registrar Medicamentos:";
			// 
			// button4
			// 
			...
			// button5
			// 
			this.button5.Location = new System.Drawing.Point(38, 308);
			...
			// button6
			// 
			this.button6.Location = new System.Drawing.Point(167, 308);
			...
			// button7
			// 
			this.button7.Location = new System.Drawing.Point(308, 308);
			this.button7.Name = "button7";
			this.button7.Size = new System.Drawing.Size(75, 23);
			this.button7.TabIndex = 10;
			this.button7.Text = "Exibir";
